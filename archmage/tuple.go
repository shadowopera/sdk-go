...
func MakeTuple1[T0 any](v0 T0) Tuple1[T0] {
	return Tuple1[T0]{v0}
}

// Values returns all tuple items as a slice.
func (t *Tuple1[T0]) Values() []any {
	return []any{t.Item0}
}
...
// Values returns all tuple items as a slice.
func (t *Tuple2[T0, T1]) Values() []any {
	return []any{t.Item0, t.Item1}
}
...
// Values returns all tuple items as a slice.
func (t *Tuple3[T0, T1, T2]) Values() []any {
	return []any{t.Item0, t.Item1, t.Item2}
}

// Unpack returns the tuple's values.
func (t *Tuple3[T0, T1, T2]) Unpack() (T0, T1, T2) {
	return t.Item0, t.Item1, t.Item2
}
...
// Values returns all tuple items as a slice.
func (t *Tuple4[T0, T1, T2, T3]) Values() []any {
	return []any{t.Item0, t.Item1, t.Item2, t.Item3}
}

// Unpack returns the tuple's values.
func (t *Tuple4[T0, T1, T2, T3]) Unpack() (T0, T1, T2, T3) {
	return t.Item0, t.Item1, t.Item2, t.Item3
}
...
func MakeTuple5[T0, T1, T2, T3, T4 any](
...
// Values returns all tuple items as a slice.
func (t *Tuple5[T0, T1, T2, T3, T4]) Values() []any {
	return []any{t.Item0, t.Item1, t.Item2, t.Item3, t.Item4}
}

// Unpack returns the tuple's values.
func (t *Tuple5[T0, T1, T2, T3, T4]) Unpack() (T0, T1, T2, T3, T4) {
	return t.Item0, t.Item1, t.Item2, t.Item3, t.Item4
}
...
func MakeTuple6[T0, T1, T2, T3, T4, T5 any](
...
// Values returns all tuple items as a slice.
func (t *Tuple6[T0, T1, T2, T3, T4, T5]) Values() []any {
	return []any{t.Item0, t.Item1, t.Item2, t.Item3, t.Item4, t.Item5}
}
...
func MakeTuple7[T0, T1, T2, T3, T4, T5, T6 any](
...
// Values returns all tuple items as a slice.
func (t *Tuple7[T0, T1, T2, T3, T4, T5, T6]) Values() []any {
	return []any{t.Item0, t.Item1, t.Item2, t.Item3, t.Item4, t.Item5, t.Item6}
}

// Unpack returns the tuple's values.
func (t *Tuple7[T0, T1, T2, T3, T4, T5, T6]) Unpack() (T0, T1, T2, T3, T4, T5, T6) {
	return t.Item0, t.Item1, t.Item2, t.Item3, t.Item4, t.Item5, t.Item6
}
